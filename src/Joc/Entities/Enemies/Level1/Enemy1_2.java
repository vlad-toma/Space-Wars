...
public class Enemy1_2 extends Enemy {

    private long rand = new Random().nextInt(140) * 100000000L;

    public Enemy1_2(RefLink refLink, float x, float y, float scale) {
        super(refLink, x, y, Assets.enemy1_2.getWidth(), Assets.enemy1_2.getHeight(), scale);
        setTexture(Assets.enemy1_2);
        setHealth(50);
        setSpeed(0.0f);
