...
public class Enemy3_2 extends Enemy {

    private long rand = new Random().nextInt(140) * 80000000L;

    public Enemy3_2(RefLink refLink, float x, float y, float scale) {
        super(refLink, x, y, Assets.enemy3_2.getWidth(), Assets.enemy3_2.getHeight(), scale);
        setTexture(Assets.enemy3_2);
        setHealth(50);
        setSpeed(0.0f);
        initHitbox(2, 1, 28, 30);
