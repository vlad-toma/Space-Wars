...
public class Boss3_2 extends Enemy {

    private long rand = new Random().nextInt(70) * 40000000L;

    public Boss3_2(RefLink refLink, float x, float y, float scale) {
        super(refLink, x, y, Assets.boss3_2.getWidth(), Assets.boss3_2.getHeight(), scale);
        setTexture(Assets.boss3_2);
        setHealth(50);
        setSpeed(0.0f);
