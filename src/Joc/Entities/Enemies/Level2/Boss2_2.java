...
public class Boss2_2 extends Enemy {

    private long rand = new Random().nextInt(70) * 60000000L;


    public Boss2_2(RefLink refLink, float x, float y, float scale) {
        super(refLink, x, y, Assets.boss2_2.getWidth(), Assets.boss2_2.getHeight(), scale);
        setTexture(Assets.boss2_2);
        setHealth(50);
        setSpeed(0.0f);
