...
public class Enemy2_1 extends Enemy {
    private long rand = new Random().nextInt(140) * 90000000L;

    public Enemy2_1(RefLink refLink, float x, float y, float scale) {
        super(refLink, x, y, Assets.enemy2_1.getWidth(), Assets.enemy2_1.getHeight(), scale);
        setTexture(Assets.enemy2_1);
        setHealth(50);
        setSpeed(0.0f);
